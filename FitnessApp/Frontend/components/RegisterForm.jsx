  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      .then(data => {
        ...
        // Assuming the registration was successful, call onLogin to update the login state
        onLogin(); // This will trigger the state update in the parent component (App.tsx)
      })
      .catch(error => {
